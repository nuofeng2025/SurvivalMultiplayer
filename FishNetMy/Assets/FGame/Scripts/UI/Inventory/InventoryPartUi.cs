...
namespace FGame
{
    public class InventoryPartUi : MonoBehaviour,IPlane
    {
        [SerializeField]
        ...
        [SerializeField]
        private RectTransform thisRootRectT;
        [SerializeField]
        private RectTransform ItemRootRectT;
        [SerializeField]
        private RectTransform MultiItemRootRectT;
